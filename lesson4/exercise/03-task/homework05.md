...
cd /exercise/03-task
#配置环境变量
$env:ETH_RPC_URL="https://sepolia.infura.io/v3/"
$env:SENDER_PRIVATE_KEY=""
#查询区块
go run main.go -mode 01 --number 11136690
#发送交易
go run main.go -mode 02 --send --to 0x4605546ea09B1b54C5437508A95Ff3784C03B1DE --amount 0.01
#查询交易
go run main.go -mode 02 --tx  0x741016daafd2f019b94fdb6638f0605e39f1b570608acd7c5bef904ee6b92a23
```
...
```shell
#
#erc20_go_demo 生成 MyERC20.abi.json
#npx hardhat run scripts/exportAbi.ts
# 生成 Go 绑定代码
cd /exercise/04-task
mkdir bindings
go tool abigen   --abi ./abi/MyERC20.abi.json   --pkg bindings   --type MyERC20   --out ./bindings/MyERC20.go
# 运行合约交互代码
go run main.go
```
